Contributing to Aimn Core
============================

The Aimn Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Aimn Core project, and is not to be
confused with overall Aimn Network Protocol consensus changes.

Whether a pull request is merged into Aimn Core rests with the project merge
...
Patches that change Aimn consensus rules are considerably more involved than
...
Where a patch set proposes to change the Aimn consensus, it must have been
...
The project leader is the release manager for each Aimn Core release.
