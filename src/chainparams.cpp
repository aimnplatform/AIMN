...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("047a2495b915a1c1c0d38bb3d24ed4586ebc401fdbe6c3785db792da219ac73d8a942fd0d44e38156588ead750a667a3fb184e839f3fa9a020cf9f49e5f80c5bda");
        nDefaultPort = 11766;
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Aimn: 1 day
        nTargetSpacing = 1 * 60;  // Aimn: 1 minute
        nMaturity = 50;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Team for a change";
...
//end of Genesis code generator
        ...
        strSporkKey = "047a2495b915a1c1c0d38bb3d24ed4586ebc401fdbe6c3785db792da219ac73d8a942fd0d44e38156588ead750a667a3fb184e839f3fa9a020cf9f49e5f80c5bda";
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("04ef3f436e6a0bf0bdf8bea0d6e8a8b4da716b789e8be66c17338e45d9a26dbe13e9f0135ed52c2549ac83a8dd9c1f1ff0a28a7dd1a1bc7c463562f1bd9f65443c");
        nDefaultPort = 11773;
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Aimn: 1 day
        nTargetSpacing = 1 * 10;  // Aimn: 1 minute
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet aimn addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet aimn script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet aimn BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet aimn BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet aimn BIP44 coin type is '1' (All coin's testnet default)
        ...
        strSporkKey = "04ef3f436e6a0bf0bdf8bea0d6e8a8b4da716b789e8be66c17338e45d9a26dbe13e9f0135ed52c2549ac83a8dd9c1f1ff0a28a7dd1a1bc7c463562f1bd9f65443c"; 
        strObfuscationPoolDummyAddress = "PCYiHgGJJ6xGHqivmdZrYjRnhaYf6AJ2Mp";
