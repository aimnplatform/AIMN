...
/* Aimn GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Aimn"
#define QAPP_ORG_DOMAIN "aimn.org"
#define QAPP_APP_NAME_DEFAULT "Aimn-Qt"
#define QAPP_APP_NAME_TESTNET "Aimn-Qt-testnet"
