...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(AIMN);
    unitlist.append(mAIMN);
    unitlist.append(uAIMN);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case AIMN:
        return QString("aimn");
    case mAIMN:
        return QString("maimn");
    case uAIMN:
        return QString::fromUtf8("uaimn");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case AIMN:
            return QString("tAIMN");
        case mAIMN:
            return QString("mtAIMN");
        case uAIMN:
            return QString::fromUtf8("μtAIMN");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case AIMN:
            return QString("AIMN");
        case mAIMN:
            return QString("Milli-AIMN (1 / 1" THIN_SP_UTF8 "000)");
        case uAIMN:
            return QString("Micro-AIMN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case AIMN:
            return QString("TestAIMNs");
        case mAIMN:
            return QString("Milli-TestAIMN (1 / 1" THIN_SP_UTF8 "000)");
        case uAIMN:
            return QString("Micro-TestAIMN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
