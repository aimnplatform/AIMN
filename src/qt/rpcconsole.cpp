                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzaimnPathCustom = GetArg("-zaimnbackuppath", "");
    ...
    if(!strzaimnPathCustom.empty()) {
        ui->wallet_customzaimnbackuppath->setText(QString::fromStdString(strzaimnPathCustom));
        ui->wallet_customzaimnbackuppath_label->setVisible(true);
        ui->wallet_customzaimnbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzaimnPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Aimn RPC console.") + "<br>" +
