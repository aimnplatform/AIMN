                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Aimn Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Aimn address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aimn: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zAIMN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Aimn Core"), this);
    aboutAction->setStatusTip(tr("Show information about Aimn Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Aimn"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Aimn addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Aimn addresses"));
    ...
    openAction->setStatusTip(tr("Open a Aimn: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Aimn Core help message to get a list with possible Aimn command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Aimn Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Aimn network", "", count));
}
...
{
    QString strTitle = tr("Aimn Core"); // default title
