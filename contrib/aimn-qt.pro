...
RESOURCES += src/qt/aimn.qrc src/qt/aimn_locale.qrc

TRANSLATIONS += src/qt/locale/aimn_bg.ts \
                src/qt/locale/aimn_de.ts \
                src/qt/locale/aimn_en.ts \
                src/qt/locale/aimn_es.ts \
                src/qt/locale/aimn_fi.ts \
                src/qt/locale/aimn_fr.ts \
                src/qt/locale/aimn_it.ts \
                src/qt/locale/aimn_ja.ts \
                src/qt/locale/aimn_pl.ts \
                src/qt/locale/aimn_pt.ts \
                src/qt/locale/aimn_ru.ts \
                src/qt/locale/aimn_sk.ts \
                src/qt/locale/aimn_sv.ts \
                src/qt/locale/aimn_vi.ts \
                src/qt/locale/aimn_zh_CN.ts \
                src/qt/locale/aimn_zh_TW.ts
