...
#   c) node1 mines 32 blocks, so now node 0 has 60001aimn, node 1 has 4250aimn, node2 has none.
#   d) node0 sends 601 aimn to node2, in two transactions (301 aimn, then 300 aimn).
