...
In order to support loading of multiple wallets in aimn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is aimn.cpp.
...
Changes to aimn.cpp
----------------------
aimn.cpp is the entry point into aimn-qt, and as such, will require some minor modifications to provide hooks for
