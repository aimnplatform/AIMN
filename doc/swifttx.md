...
* WebSocket: [https://github.com/aimnproject/insight-api-aimn#web-socket-api](https://github.com/aimnproject/insight-api-aimn#web-socket-api) 
* API: [https://github.com/aimnproject/insight-api-aimn#swifttx-transactions](https://github.com/aimnproject/insight-api-aimn#swifttx-transactions) 
...
By default, the Aimn Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Aimn Core daemon:
